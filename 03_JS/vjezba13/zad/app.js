...
document.getElementById('mjesto-projekta').focus();obrazac.addEventListener('submit', (dogadaj) => {
    dogadaj.preventDefault();
    kontejnerPogreske.innerText = ''; 
    kontejnerPogreskeDolje.innerText = ''; 
    try {
      const konacniPodaci = {
            mjesto: provjeriTekst(document.getElementById('mjesto-projekta'), 'Mjesto projekta minimalno 4 znaaka'),
            projekt: provjeriTekst(document.getElementById('naziv-projekta'), 'Minimalno 3 znaka za  naziv projekta'),
